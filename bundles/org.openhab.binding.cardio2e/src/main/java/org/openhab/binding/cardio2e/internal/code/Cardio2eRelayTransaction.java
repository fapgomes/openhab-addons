...
public class Cardio2eRelayTransaction extends Cardio2eTransaction {
    ...
    public Cardio2eRelayTransaction(short objectNumber, Cardio2eRelayStates relayState) { // Simple SET transactionType
    ...
    public void blindMoveUp() {
        if (blindUpMode) {
            ...
            if (blindDownMode) {
                ...
                throw new UnsupportedOperationException("Blind move up not allowed for this relay");
            }
        }
    }
    ...
    public void blindMoveDown() {
        if (blindDownMode) {
            ...
            if (blindUpMode) {
                ...
                throw new UnsupportedOperationException("Blind move down not allowed for this relay");
            }
        }
    }
    ...
    public void blindStop() {
        if ((blindUpMode) || (blindDownMode)) {
            ...
            throw new UnsupportedOperationException("Blind stop not allowed for this relay");
        }
    }
            ...
            switch (getTransactionType()) {
                ...
                case SET:
                    returnString = String.format("%s%s %s %d %s%s", CARDIO2E_START_TRANSACTION_INITIATOR,
                            getTransactionType().symbol, getObjectType().symbol, getObjectNumber(), relayState.symbol,
                            CARDIO2E_END_TRANSACTION_CHARACTER);
                    break;
            }
        }
